...
// --- Montreal neighbourhood by name (researched from each place's address;
// blank = unknown / chain with several locations / not in Montreal — fill in
// via the ✎ Edit button in the app). ---
const NEIGHBOURHOOD = {
  "Le Nile Bleu": "Plateau-Mont-Royal",
  "Picks": "Downtown (Ville-Marie)",
  "Bistro Tôt ou Tard": "Plateau-Mont-Royal",
  "Kagayaki": "Chinatown",
  "Sushi Momo": "Plateau-Mont-Royal",
  "Tacos Tin Tan": "Plateau-Mont-Royal",
  "Le P'tit Rustik": "Plateau-Mont-Royal",
  "Pho Nguyen": "Downtown (Ville-Marie)",
  "Dandy": "Old Montreal",
  "Le Toaster": "Villeray",
  "Le Mekong": "Plateau-Mont-Royal",
  "Muru Crêpes": "Old Montreal",
  "India Rosa Griffintown": "Griffintown",
  "Chef Lee": "Downtown (Ville-Marie)",
  "Pho Saigon Vietnam": "Chinatown",
  "Resto Végo": "Quartier Latin",
  "Bun Mam Ninh Kieu": "Plateau-Mont-Royal",
  "Restaurant Coréen Luna": "Plateau-Mont-Royal",
  "Tsukuyomi Ramen Crescent": "Downtown (Ville-Marie)",
  "Jako": "Downtown (Ville-Marie)",
  "Omnivore": "Plateau-Mont-Royal",
  "Nouilles Yunan": "Chinatown",
  "Icehouse": "Plateau-Mont-Royal",
  "Chu Chai": "Plateau-Mont-Royal",
  "Nos The": "Downtown (Ville-Marie)",
  "Ginko": "Quartier Latin",
  "Bvrger": "Old Montreal",
  "Mimosa café": "Plateau-Mont-Royal",
  "Yokato Yokabai": "Plateau-Mont-Royal",
  "Shushu Thai": "Little Burgundy",
  "Sunny Dinette": "Saint-Henri",
  "Maison v.i.p": "Chinatown",
  "Sun Sushi": "Downtown (Ville-Marie)",
  "Bazar Café": "La Petite-Patrie",
  "Queen Sheba": "Plateau-Mont-Royal",
  "Shushu Ramen": "Pointe-Saint-Charles",
  "Moa Moa": "Verdun",
  "Escondite Drummond": "Downtown (Ville-Marie)",
  "Kim Galbi": "Downtown (Ville-Marie)",
  "Au Pain Perdu": "Plateau-Mont-Royal",
  "Burgundy Lion": "Little Burgundy",
  "Haidalio hot pot": "Downtown (Ville-Marie)",
  "Bagel etc": "Plateau-Mont-Royal",
  "Bvrger Fiancé": "Old Montreal",
  "MONO": "Downtown (Ville-Marie)",
  "Bloom Sushi": "Downtown (Ville-Marie)",
  "Rendez-vous Bistro Indien": "Plateau-Mont-Royal",
  "Kiodai Izakaya": "Downtown (Ville-Marie)",
  "Katsuya": "Downtown (Ville-Marie)",
  "Bistro King Creole": "Hochelaga-Maisonneuve",
  "Greenspot": "Saint-Henri",
  "Trattoria Trestevere": "Downtown (Ville-Marie)",
  "Dobe & Andy": "Chinatown",
  "Lulu Épicerie": "Little Burgundy",
  "Lali's": "Downtown (Ville-Marie)",
  "Kinton Ramen Westmount": "Westmount",
  "Foeigwa Brunch": "Saint-Henri",
  "Quoi de neuf": "Little Burgundy",
  "Garden Room": "Downtown (Ville-Marie)",
  "Souvlaki Grec Plus": "Saint-Henri",
  "Bismillah Poulet Grillé Cuisine Indienne": "Little Burgundy",
  "Aqua E Farina": "Notre-Dame-de-Grâce",
  "Joyo Burger Wellington": "Verdun",
  "The Sparrow": "Mile End",
  "Luyishou Fondue": "Downtown (Ville-Marie)",
  "House of Taste": "Lachine",
  "Millmans": "Verdun",
  "Neotokyo": "Downtown (Ville-Marie)",
  "Ma Poule Mouillée": "Plateau-Mont-Royal",
  "Kinton Ramen Square Victoria": "Old Montreal",
  "Sammi Soup Dumpling": "Chinatown",
  "Tacos Lakalaka": "Hochelaga-Maisonneuve",
  "3 Madames": "Verdun",
  "Le Petit Dek Sen": "Notre-Dame-de-Grâce",
  "Siwalee": "Plateau-Mont-Royal",
  "Harbin St Denis": "Plateau-Mont-Royal",
  "Pho Ahn Express": "Plateau-Mont-Royal",
  "Escondite Union": "Downtown (Ville-Marie)",
};
...
function parse(raw) {
  ...
  for (const lineRaw of raw.split("\n")) {
    ...
    out.push({
      ...
      city: rowCity,
      neighbourhood: rowCity === "Montreal" ? (NEIGHBOURHOOD[name] || "") : "",
      comment,
      visits: visitObjs,
      sort: order,
    });
...
for (const r of data) {
  sql +=
    `INSERT INTO restaurants (id, name, cuisine, city, neighbourhood, comment, visits, sort) VALUES (` +
    `'${esc(r.id)}', '${esc(r.name)}', '${esc(r.cuisine)}', '${esc(r.city)}', '${esc(r.neighbourhood)}', ` +
